        ...
        <div>
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-35 lg:py-40">
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <a
                                href="#"
                                className="rounded-md bg-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >
                                Get started
                            </a>
            ...
            <div className='grid md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 justify-around gap-4 container px-16'>
              {CardArray.map((card, index) => (
                <div className='flex flex-col items-center mb-12 border-gray-200 border-2 rounded-xl shadow-xl w-[100] h-auto p-4'>
